...
QLength WheelBase = 11.5_in;
QLength TrackingWDiameter = 2.75_in;
QLength TrackingWBase = 7_in;
QLength MiddleWheel = 1_in;
...
void EncoderChassisPID () {
  ...
  // Green gearset, 4 inch wheel diameter, 11.5 inch wheelbase
    ...
    .withDimensions(AbstractMotor::gearset::green, {{TrackingWDiameter, TrackingWBase, MiddleWheel, TrackingWDiameter}, imev5GreenTPR})
